...
As 2018 comes to a close there are a number of applications and services which allow users to traverse the NHDPlus stream network.  For this project I am proposing a rough division into three main branches: "Classic", "NLDI" and my own hybrid, "WATERS v3.0".  The term "Classic" is entirely my own and meant without irony and with respect.  I chose this term over the competiting "legacy" term used for the older logic by the NLDI project.  Your feedback is most welcome.
