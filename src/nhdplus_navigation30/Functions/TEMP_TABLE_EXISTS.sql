CREATE or REPLACE FUNCTION nhdplus_navigation30.temp_table_exists(
...
ALTER FUNCTION nhdplus_navigation30.temp_table_exists(
   VARCHAR
) OWNER TO nhdplus_navigation30;

GRANT EXECUTE ON FUNCTION nhdplus_navigation30.temp_table_exists(
   VARCHAR
) TO PUBLIC;
